...
const Product = () => {
  ...
  // ------------------------
  // Fetch product from global products
  // ------------------------
      ...
      <div className="px-6 md:px-16 lg:px-32 pt-14 space-y-10 mt-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-foreground/80 mt-3">{productData.description}</p>
              ...
              <table className="table-auto border-collapse w-full max-w-72">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="text-foreground/80">{productData.category}</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <div className="flex flex-col items-center">
          ...
          <button
            ...
            className="px-8 py-2 mb-16 border border-foreground rounded text-foreground hover:bg-foreground hover:text-background transition cursor-pointer"
          >
            See more
          </button>
        </div>
